	...
	{{ bForm::text('name', Input::old('name'), array('id' => 'name', 'placeholder' => 'Name'), 'Name') }}
	...
	{{ bForm::text('level', Input::old('level'), array('id' => 'level', 'placeholder' => 'Level'), 'Level') }}
	{{ bForm::text('experience', Input::old('experience'), array('id' => 'experience', 'placeholder' => 'Experience'), 'Experience') }}
	{{ bForm::text('hitPoints', Input::old('hitPoints'), array('id' => 'hitPoints', 'placeholder' => 'LP'), 'LP') }}
